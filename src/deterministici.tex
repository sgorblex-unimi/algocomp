...
\begin{figure}
	...
	\caption{Esempio di grafo bipartito. I lati evidenziati rappresentano un possibile matching.}
...
\begin{figure}
	...
	\begin{subfigure}[b]{0.4\textwidth}
		\centering
		\input{img/matching_flip_pre.tikz}
		\subcaption{Prima del flip.}
	\end{subfigure}
	\begin{subfigure}[b]{0.4\textwidth}
		\centering
		\input{img/matching_flip_post.tikz}
...
\begin{proof}
	...
	\begin{figure}[ht]
		\centering
		\input{img/christofides_badinput.tikz}
