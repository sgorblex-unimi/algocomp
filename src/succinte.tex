...
\begin{figure}
	\input{img/bitree_definizione.tikz}
...
A titolo si esempio si veda la figura \ref{fig:paren_blocks}.

\begin{figure}[ht]
	\centering
	\input{img/dyck_classi_parentesi.tikz}
	\caption{Divisione in blocchi di una parola di Dyck. Le parentesi verdi sono vicine, quelle rosse sono pioniere e quelle blu sono non-pioniere.}
